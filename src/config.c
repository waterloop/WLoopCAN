...
const Field TARGET_POWER		= {0x00000007, 0, 4};
	...
	const Field BATTERY_PACK_VOLTAGE		= {0x0000000A, 0, 4};
	const Field STATE_OF_CHARGE				= {0x0000000A, 4, 8};
	const Field BUCK_TEMPERATURE			= {0x0000000B, 0, 4};
	const Field BMS_CURRENT					= {0x0000000B, 4, 8};
	const Field MC_CAP_VOLTAGE				= {0x0000000C, 0, 4};
	const Field BMS_STATE_CHANGE_ACK_NACK	= {0x0000000D, 0, 1};
#endif

#ifdef MOTOR_CONTROLLER
	const Field IGBT_TEMPERATURE			= {0x00000002, 0, 4};
	const Field MOTOR_VOLTAGE				= {0x00000002, 4, 8};
	const Field POD_SPEED					= {0x00000015, 0, 4};
	const Field MOTOR_CURRENT				= {0x00000015, 4, 8};
	const Field BATTERY_CURRENT				= {0x00000016, 0, 4};
	const Field BATTERY_VOLTAGE				= {0x00000016, 4, 8};
	const Field MC_STATE_CHANGE_ACK_NACK	= {0x00000017, 0, 1};
#endif

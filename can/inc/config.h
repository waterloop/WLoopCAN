...
typedef enum {
    BATTERY_OVERVOLTAGE = 0x00,
    BATTERY_UNDERVOLTAGAE = 0x01,
    BATTERY_OVERCURRENT = 0x02,
    BATTERY_SOC = 0x03,
    CELL_UNDERVOLTAGE = 0x04,
    CELL_OVERVOLTAGE = 0x05,
    CELL_TEMPERATURE = 0x06,
    BUCK_TEMPERATURE = 0x07
} BmsErrorCode;

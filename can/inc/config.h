...
#define BUS_TEST_REQ_BASE 0x7FE0
// BUS_TEST_REQ
#define RASPBERRY_PI_REQ BUS_TEST_REQ_BASE | 1
#define MASTER_BMS_REQ BUS_TEST_REQ_BASE | 2
#define MOTOR_CONTROLLER_REQ BUS_TEST_REQ_BASE | 3
#define TEMPERATURE_SENSOR_REQ BUS_TEST_REQ_BASE | 4
#define PRESSURE_SENSOR_REQ BUS_TEST_REQ_BASE | 5
#define RING_ENCODER_REQ BUS_TEST_REQ_BASE | 6
#define LV_POWER_REQ BUS_TEST_REQ_BASE | 7

// 0b0000011111111111
#define BUS_TEST_REQ_MASK 0x07FF

#define BUS_TEST_RESP_BASE 0x7FF0
// BUS_TEST_RESP
#define RASPBERRY_PI_RESP BUS_TEST_RESP_BASE | 1
#define MASTER_BMS_RESP BUS_TEST_RESP_BASE | 2
#define MOTOR_CONTROLLER_RESP BUS_TEST_RESP_BASE | 3
#define TEMPERATURE_SENSOR_RESP BUS_TEST_RESP_BASE | 4
#define PRESSURE_SENSOR_RESP BUS_TEST_RESP_BASE | 5
#define RING_ENCODER_RESP BUS_TEST_RESP_BASE | 6
#define LV_POWER_RESP BUS_TEST_RESP_BASE | 7
